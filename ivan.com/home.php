...
<div class="col-lg-9 mt-2">
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        ?>
            ...
            <img src="assets/img/<?php echo $data['foto'] ?>" class="img-fluid" style="height:400px; width:1000px; object-fit:cover" alt="...">
...
<div class="card mt-2 border-0 bg-light">
    <div class="card-body text-center">
        <h5 class="card-title">DECAFE - APLIKASI PEMESANAN DAN MINUMAN CAFE DAN RESTORAN</h5>
