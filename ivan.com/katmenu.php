        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <buttton class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahUser">Tambah Kategori Menu</buttton>
                </div>
            </div>
            <!-- Modal Tambah Menu Kategori Baru -->
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_katmenu.php" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="input_katmenu_validate" value="Ivan">Save changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <!-- Akhir Modal Tambah Menu Kategori Baru -->
            <?php
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_katmenu.php" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <select name="jenismenu" id="" class="form-select" aria-lebel="Default select example" required>
                                                    <?php
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_katmenu.php" method="POST">
                                    <input type="hidden" class="form-control" value="<?php echo $row['id_kat_menu'] ?>" name="id">
                                    <div class="col-lg-12">
                                        Apakah anda yakin ingin menghapus kategori menu <?php echo $row['kategori_menu'] ?>?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        <button type="submit" class="btn btn-danger" name="hapus_kategori_validate" value="Ivan">Hapus</button>
                                    </div>
                                </form>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button class="btn btn-danger btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalHapus<?php echo $row['id_kat_menu'] ?>"><i class="bi bi-trash3"></i></button>
                                    </td>
                                </tr>
                            <?php
                            }
